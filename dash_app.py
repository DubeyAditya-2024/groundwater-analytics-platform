...
TRANSLATIONS = {
    ...
    "CRITICAL ALERT: Anomaly Detected. Immediate action required for ": {
        "hi": "⚠️ महत्वपूर्ण चेतावनी: विसंगति का पता चला। के लिए तत्काल कार्रवाई आवश्यक है ",
        "ta": "⚠️ முக்கியமான எச்சரிக்கை: அசாதாரணத்தைக் கண்டறிந்தது. இதற்கு உடனடியாக நடவடிக்கை தேவை "
    },
...
if __name__ == '__main__':
    # Initial run to generate data and populate the store
    # This ensures the dashboard doesn't start with an empty log/data
